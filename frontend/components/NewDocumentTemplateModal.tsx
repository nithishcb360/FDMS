...
export default function NewDocumentTemplateModal({ isOpen, onClose, onTemplateCreated }: NewDocumentTemplateModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert('Document template created successfully!');
      onTemplateCreated?.();
      onClose();
    } catch (error: any) {
      ...
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-2xl">
        ...
        <div className="border-b border-gray-200 px-6 py-4">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-xl font-bold text-gray-900">New Document Template</h2>
              <p className="text-sm text-gray-500 mt-1">Create a new document template</p>
            </div>
            <button
              onClick={onClose}
